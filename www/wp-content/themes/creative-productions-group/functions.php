...
function cpg_enqueue_scripts() {
	// Theme CSS
	wp_enqueue_style( 'cpg=grid', get_stylesheet_directory_uri() . '/css/grid.css' );
	...
	wp_enqueue_style( 'cpg-flexslider' , get_template_directory_uri() . '/css/flexslider.css');
	wp_enqueue_style( 'cpg-push-menu' , get_template_directory_uri() . '/css/jPushMenu.css');

	// Theme JS
	wp_enqueue_script( 'cpg-theme-js', get_template_directory_uri() . '/js/theme.js', array( 'jquery' ), false, true );
	wp_enqueue_script( 'cpg-froogaloop' , get_template_directory_uri() . '/js/froogaloop.min.js', array('jquery'), '' , true);
	wp_enqueue_script( 'cpg-flexslider' , get_template_directory_uri() . '/js/jquery.flexslider-min.js', array('jquery'), '' , true);
	wp_enqueue_script( 'cpg-mousewheel' , get_template_directory_uri() . '/js/jquery.mousewheel.js', array('jquery'), '' , true);
	wp_enqueue_script( 'cpg-easing' , get_template_directory_uri() . '/js/jquery.easing.js', array('jquery'), '' , true);
	wp_enqueue_script( 'cpg-fittext' , get_template_directory_uri() . '/js/jquery.fittext.js', array('jquery'), '' , true);
	wp_enqueue_script( 'cpg-pushmenu' , get_template_directory_uri() . '/js/jPushMenu.js', array('jquery'), '' , true);
}
 ...
 * @return void
 */
function cpg_share_buttons_above_post( $content = '' ) {
...
add_filter( 'the_content', 'cpg_share_buttons_above_post', 19 );
add_filter( 'the_excerpt', 'cpg_share_buttons_above_post', 19 );
